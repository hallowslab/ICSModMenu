...
namespace ICSModMenu.Menus
{
    public class CheatsMenu
    {
        ...
        public void Draw()
        {
            GUI.Box(new Rect(10, 10, 240, 300), "Cheats Menu");

            //
            // MONEY SECTION
            //
            GUI.Label(new Rect(20, 40, 80, 20), "Amount:");
            moneyText = GUI.TextField(new Rect(70, 40, 100, 20), moneyText);
            ...
            if (plugin.PlayerStats != null)
            {
                ...
                hungerValue = GUI.HorizontalSlider(
                    new Rect(70, 115, 120, 20),
                    hungerValue,
                    0f,
                    100f
                );

                GUI.Label(new Rect(195, 110, 50, 20), $"{hungerValue:F0}");
            ...
            {
                GUI.Label(new Rect(20, 180, 200, 20), "TrashSystem not available yet");
            }

            //
            // Back Button
            //
            if (GUI.Button(new Rect(buttonX, 220, buttonWidth, buttonHeight), "Back"))
            {
